...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (cm.getPlayer().getLevel() < 255 && cm.getJob() == 0) {
            ...
            if (cm.getJob() == 410) {
                ...
                cm.worldMessage(6,"[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 管理员 快速转职成功！");
            } else if (cm.getJob() == 110) {
                cm.worldMessage(6,"[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 管理员 快速转职成功！");
            } else if (cm.getJob() == 120) {
                cm.worldMessage(6,"[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 管理员 快速转职成功！");
    ...
    cm.teachSkill(5221010,0,5);
            ...
            if(cm.getJob() == 1000 && cm.getPlayer().getLevel()>=10){
                ...
                cm.worldMessage(6,"[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 管理员 快速转职为骑士团职业！");
                cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！");
            } else if(parseInt(cm.getJob() / 100) >10 && cm.getPlayer().getLevel()>=30 && cm.getJob()%100 == 0){
            ...
            if(cm.getJob() == 2000 && cm.getPlayer().getLevel() >=10){
				...
				cm.teachSkill(21000002,0,20); //双重重击
				cm.teachSkill(21001003,0,20); //快速矛
                cm.worldMessage(6,"[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 管理员 快速转职为战神职业！");
                cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！");
            } else if(cm.getJob() == 2100 && cm.getPlayer().getLevel() >=30){
                cm.changeJob(2110);
                ...
                cm.worldMessage(6,"[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 管理员 快速完成战神2次转职！");
               ...
               // cm.teachSkill(21120010,0,0); //战神之舞
                cm.worldMessage(6,"[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 管理员 快速完成战神3次转职！");
               ...
               // cm.teachSkill(21120010,0,0); //战神之舞
                ...
                cm.changeJob(2112);
                cm.worldMessage(6,"[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 管理员 快速完成战神4次转职！");
