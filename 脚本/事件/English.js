...
var letters2 = Array("Lirin最喜欢什么动物??", "金字塔法老王是什么颜色??", "请给我的这些字母 [REINDEER]","情人节玫瑰是48级?”,“要多少经验水平1 - 2 ?”、“交流点投票调频谁?”、“谁是这个服务器的所有者(提示:_ _ _ _ _ _)吗?”,“初学者成为魔术师什么水平?”、“埃文开始的什么城市?”、“黑色的翅膀是什么镇?”、“什么是野生猎人,战斗法师,和力学?”、“什么类型的龙是米尔?”、“米尔的祖先是谁?”、“阿然使用什么武器?”、“技工的工作老师是谁?", "冒险家三转需要用到哪一种石头??", "哪一个NPC可以给你第一只宠物??", "狂暴猎人的豹英文??", "皇家骑士团几等可以四转??", "装备潜能何属性最为特殊,罕见??", "PB头上的雕像名字是??", "暗黑龙王靠近哪个地图??", "在枫之谷世界中扎昆多少级才能挑战??");
...
function playerEntry(eim, player) {
	...
	if (eim.getProperty("mode").equals("0")) {
		player.sendEnglishQuiz("在英语村的 [" + eim.getProperty("question") + "] 怪物代表什么??");
	} else if (eim.getProperty("mode").equals("1")) {
		player.sendEnglishQuiz("请给我这些字母 #i" + parseInt(eim.getProperty("question")) + "#.");
	} else if (eim.getProperty("mode").equals("2")) {
