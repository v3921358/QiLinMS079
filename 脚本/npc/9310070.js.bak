...
{ 类型: 2370000, 数量: 5, 目录: 100 },
{ 类型: 4000423, 数量: 1, 目录: 100 },
{ 类型: 3010045, 数量: 1, 目录: 100 },//会员礼包1
...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		var text = "";
		text += "\t\t\t\t#e#d#v5120030#赞助累积大礼包#v5120030#\r\n\r\n";
		s = 0;
		for (var c = 0; c < xmxszML.length; c++) { //

			if (xmxszML[c].编号 >= 领取次数) {
				text += "#L" + xmxszML[c].编号 + "#"+星星+"#e#d充值消费满  [#r" + 当前充值 + "#d/" + xmxszML[c].目录 + "]\r\n\r\n"
              s++;
			}
