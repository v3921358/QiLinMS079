    ...
    switch (cm.getPlayer().getMapId()) {
        ...
        case 920010100:
            if (em.getProperty("stage").equals("6")) {
                ...
                cm.sendOk("请收集#v4001044##v4001045##v4001046##v4001047##v4001048##v4001049# 女神雕像的碎片，然后来找我谈话获得最后一块。");
                cm.dispose();
            }
            break;
            //雅典娜的禁地<散布路>第一个碎片
