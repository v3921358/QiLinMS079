...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        var selStr = "\t"+大水滴+"#e#d亲爱的玩家 #r[#h ##k#r]#d,欢迎来到 #r[" + cm.getChannelServer().getServerName() + "] "+大水滴+"#k\r\n\r\n";// 
		...
		//selStr += "  #r当前可用  余额:  #b"+桃花+"  " + cm.getBeans() + "  \r\n";
		//selStr += "  #r当前消费  积分:  #b"+桃花+"  " + cm.getczb() + "  \r\n";		
		selStr += "  #r当前可用  金币:  #b"+桃花+"  " + cm.getMeso() + "  点\r\n";
		//selStr += "  #r当前钓鱼  积分:  #b"+桃花+"  " + cm.getFishingJF() + "  点\r\n";
		selStr += "  #r当前组队  积分:  #b"+桃花+"  " + cm.getzdjf() + "  点\r\n";
		//selStr += "  #r当前杀怪  点数:  #b"+桃花+"  " + cm.getshaguai() + " #k\r\n";//杀怪积分兑换9900004_7007
		...
		selStr += "#L101##d"+草莓+"怪物攻城#l";
		selStr += "#L102##d"+草莓+"刷新地图#l";
		selStr += "#L103##d"+草莓+"刷新状态#l";
		//selStr += "#L104##d"+草莓+"重载爆率#l";
		
		selStr += "#L105##d"+草莓+"重载传送#l";
		selStr += "#L106##d"+草莓+"重载商店#l";
		selStr += "#L107##d"+草莓+"满 技 能#l";
		selStr += "#L108##d"+草莓+"刷 点 卷#l\r\n\r\n";
