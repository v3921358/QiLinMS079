...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#L2##b" + 蓝色箭头 + "废弃组队副本 (15-256) [通关奖励经验"+cm.getLevel()*3000+" ] \r\n"
            text += "#L3##b" + 红色箭头 + "玩具组队副本 (35-256) [通关奖励经验"+cm.getLevel()*4000+" ]\r\n"//3

            text += "#L4##b" + 蓝色箭头 + "天空组队副本 (51-256) [通关奖励经验"+cm.getLevel()*5000+" ]\r\n"
            text += "#L7##b" + 红色箭头 + "男女组队副本 (71-256) [通关奖励经验"+cm.getLevel()*6000+" ] \r\n"

            text += "#L5##b" + 蓝色箭头 + "毒物组队副本 (91-256)  [通关奖励经验"+cm.getLevel()*8000+" ]\r\n"
			text += "#L6##b" + 红色箭头 + "海盗组队副本 (110-256) [通关奖励经验"+cm.getLevel()*10000+" ]\r\n"

            text += "#L10##b" + 蓝色箭头 + "怪物嘉年华 (组队对抗副本.最低2V2)等级(30-100)#l\r\n"//3
			text += "#L38##b" + 红色箭头 + "武陵道场 (武林状元)\r\n"//3 
