...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        var 
		selStr = "       "+大黄星+""+小烟花 +"欢迎来到【 #r" + cm.getServerName() + "#k 】日常中心"+小烟花 +""+大黄星+"\r\n\r\n";
        ...
        selStr += "#e#r#L3# "+大黄星+"每日劳动#l #L1511# "+大黄星+"副本任务#l #L1521# "+大黄星+"每日任务#l\r\n\r\n";//#L1# "+小花+"每日签到#l#L15# 在线签到#l 
		selStr += "#e#b#L77# "+大黄星+"跑商任务#l #L76# "+大黄星+"家族任务#l #L7##b "+大黄星+"随机任务#l \r\n\r\n";
		selStr += "#e#b#L15# "+大黄星+"在线签到#l\r\n\r\n";//#L15# "+大黄星+"在线签到#l
