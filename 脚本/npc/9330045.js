...
function action(mode, type, selection) {
	...
	//cm.sendSimple("你想要做什么？\n\r #b#L0#进入钓鱼场#l \n\r #L1#买鱼饵#l \n\r #L2#买钓鱼椅#l \n\r #L3#用美味的饵可以#l \n\r #L4#钓鱼指南#l \n\r #L5##i1142146:#贸易500金蛋（渔王勋章[期：30天]）#l");
            ...
            text += "#e钓鱼请购买钓鱼椅#v3011000#钓鱼杆#v5340001#还有鱼饵#v2300000#\r\n#b重要提示：购买鱼饵前务必清理背包，消费之后没有获得鱼饵概不补偿#k\r\n"//3
            
            text += "#L2##r#v3011000# 300W金币(12小时)#l\r\n"//3
            text += "#L3##v5340001# 2000点券(12小时)#l\r\n"//3
            text += "#L6##v2300000# 200W普通鱼饵 (100个) [请先整理背包]#l\r\n"//3
            text += "#L4##v2300001# 2000点高级鱼饵 (100个) [请先整理背包]#l\r\n"//3
			text += "#L12##v2300000# 2000W普通鱼饵 (500个) [请先整理背包]#l\r\n"//3
            text += "#L13##v2300001# 10000点高级鱼饵 (500个) [请先整理背包]#l\r\n\r\n"//3
            text += "#L14##b#e进入钓鱼场#k#l\r\n\r\n"//3
			//text += "#L1##r#e返回自由市场#k#l\r\n\r\n"//3
