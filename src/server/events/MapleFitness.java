        ...
        msgSchedule = EventTimer.getInstance().register(new Runnable() {
            ...
            public void run() {
                ...
                if (timeLeft > 9000 && timeLeft < 11000) {
                    broadcast(MaplePacketCreator.serverNotice(0, "你還有10秒左右的时间，那些你不能擊敗的玩家，我希望你下次贏得勝利，回頭見。"));
                } else if (timeLeft > 11000 && timeLeft < 101000) {
                    broadcast(MaplePacketCreator.serverNotice(0, "好吧，你剩下沒有多少时间了，請抓緊时间衝向終點。"));
                    ...
                    broadcast(MaplePacketCreator.serverNotice(0, "有可能会小LAG一下不過不需要擔心。"));
                } else if (timeLeft > 841000) {
                    broadcast(MaplePacketCreator.serverNotice(0, "[終極忍耐] 總共有四階，如果你碰巧在游戏過程中死亡，你会從游戏中消失，所以請注意這一點。"));
                }
            }
        }, 90000);
    }
