...
public class BankItemManager {
    ...
    private static class InstanceHolder {
        ...
        public static final BankItemManager instance = new BankItemManager();
    }
...
//        }
    ...
    public List<BankItem> getItems(int cid) {
    ...
    public int update(BankItem bankItem) {
        int ret = -1;
        Connection con1 = DatabaseConnection.getConnection();
        PreparedStatement ps = null;
        try {
