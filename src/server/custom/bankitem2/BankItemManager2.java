...
public class BankItemManager2 {
    ...
    private static class InstanceHolder {
        ...
        public static final BankItemManager2 instance = new BankItemManager2();
    }
...
//        }
        ret = add(player.getId(), source.getItemId(), count);
        if (ret < 1) {
            return -8;//存库失败
        }
...
//        }
    ...
    public List<BankItem2> getItems(int cid) {
        List<BankItem2> items = new ArrayList<>();
    ...
    public int update(BankItem2 bankItem) {
        int ret = -1;
        Connection con1 = DatabaseConnection.getConnection();
        PreparedStatement ps = null;
        try {
