    ...
    public static class 伤害字型 {
        ...
        public static Map<Integer, Integer> getDamageSkin() {
            if (damageSkin.isEmpty()) {
                ...
                damageSkin.put(2431965, 0); //基本伤害肌膚
                damageSkin.put(2431966, 1); //數位顯示肌膚
                damageSkin.put(2432084, 1); //數位顯示字型
                damageSkin.put(2431967, 2); //克里提亞斯伤害肌膚
                damageSkin.put(2432131, 3); //組队任務伤害肌膚
                damageSkin.put(2432153, 4); //衝擊震撼字型
                damageSkin.put(2432638, 4); //具有衝擊性的伤害字型
                damageSkin.put(2432659, 4); //具有衝擊性的伤害字型
                damageSkin.put(2432154, 5); //甜蜜餅乾字型
                damageSkin.put(2432637, 5); //傳統韓果伤害字型
                damageSkin.put(2432658, 5); //傳統韓果伤害字型
                damageSkin.put(2432207, 6); //鐵壁城牆字型
                damageSkin.put(2432354, 7); //聖誕快樂伤害字型
                damageSkin.put(2432355, 8); //雪花飄落字型
                damageSkin.put(2432972, 8); //雪花伤害肌膚
                damageSkin.put(2432465, 9); //愛麗西亞的伤害字型
                damageSkin.put(2432479, 10); //桃樂絲的伤害字型
                damageSkin.put(2432526, 11); //鍵盤戰士字型
                damageSkin.put(2432639, 11); //鍵盤戰士伤害字型
                damageSkin.put(2432660, 11); //鍵盤戰士伤害字型
                damageSkin.put(2432532, 12); //多彩春風字型
                damageSkin.put(2432592, 13); //單身部队伤害字型
                damageSkin.put(2432640, 14); //雷咪納杉司伤害字型
                damageSkin.put(2432661, 14); //雷咪納杉司伤害字型
                damageSkin.put(2432710, 15); //菇菇寶貝伤害字型
                damageSkin.put(2432836, 16); //王冠伤害字型
                damageSkin.put(2432973, 17); //灰白伤害肌膚
                damageSkin.put(2433063, 18); //明星星球伤害肌膚
                damageSkin.put(2433456, 19); //韓文的伤害字型(效果是中文)
                damageSkin.put(2433178, 20); //2014萬聖節伤害肌膚
//            damageSkin.put(2433456, 21); //韓文的伤害字型
                damageSkin.put(2433631, 22); //NENE雞的伤害字型
                damageSkin.put(2433655, 22); //NENE雞的伤害字型
                damageSkin.put(2433981, 28); //皮卡啾伤害字型
                damageSkin.put(2432591, 1000); //櫻花浪漫字型伤害肌膚
                damageSkin.put(2432803, 1004); //濃姬伤害字型(30日)
                damageSkin.put(2432804, 1004); //濃姬伤害字型(無限期)
                damageSkin.put(2432846, 1005); //傑特字型交換卷
                damageSkin.put(2433049, 1009); //初音未來伤害字型
                ...
                //1018 - 跟1014一樣
                damageSkin.put(2433775, 1032); //殺人鯨伤害字型
                damageSkin.put(2433776, 1033); //史烏伤害字型
                damageSkin.put(2433828, 1034); //太陽伤害字型
                damageSkin.put(2433829, 1035); //雨伤害字型
                damageSkin.put(2433830, 1036); //彩虹伤害字型
                damageSkin.put(2433831, 1037); //雪伤害字型
                damageSkin.put(2433832, 1038); //閃電伤害字型
                damageSkin.put(2433833, 1039); //風伤害字型
...
//                case 5062001://超級奇幻方塊
//                    type -= CubeType.傳說.getValue();
//                    type |= CubeType.調整潜能條數.getValue();
//                    break;
//                case 5062004://星星方塊
//                    type -= CubeType.傳說.getValue();
//                    type |= CubeType.去掉無用潜能.getValue();
//                    break;
//                case 5062013://太陽方塊
//                    type |= CubeType.去掉無用潜能.getValue();
//                case 5062005://驚奇方塊
...
//    }
    public static class 類型 {
        ...
        public static boolean 寵物装备(int itemid) {
        ...
        public static boolean 提升卷(int itemid) { // 龍騎士获得的強化牌板
            return itemid >= 2047000 && itemid < 2047310;
        }

        public static boolean 附加潜能卷軸(int itemid) {
        ...
        public static boolean 装备強化卷軸(int itemid) {
        ...
        public static boolean 潜能卷軸(int itemid) {
        ...
        public static boolean 保護卷軸(int itemid) {
            switch (itemid) {
                case 5063100://幸運保護券(防爆+幸運)
                case 5064000://装备保護卷軸(無法用於尊貴或12星以上)
                case 5064002://星光装备保護卷軸(105以下的装备且無法用於尊貴或12星以上)
                case 5064003://尊貴装备保護卷軸(無法用於非尊貴以及尊貴7星以上)
                case 5064004://[MS特價] 装备保護卷軸(無法用於尊貴或12星以上)
                    return true;
                default:
        ...
        public static boolean 安全卷軸(int itemid) {
            switch (itemid) {
                case 5064100://安全盾牌卷軸
                case 5064101://星光安全盾牌卷軸(105以下的装备)
