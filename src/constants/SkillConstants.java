...
//    }
    ...
    public static boolean isAngel(int skillId) {
        ...
        switch (skillId) {
            ...
            case 80001525: // 火精灵瑪瑙 召喚瑪瑙戒指中的#c火精灵瑪瑙#.
            case 80001526: // 電子瑪瑙 召喚瑪瑙戒指中的#c電子瑪瑙#.
            case 80001527: // 水精灵瑪瑙 召喚瑪瑙戒指中的#c水精灵瑪瑙#.
            case 80001528: // 地精灵瑪瑙 召喚瑪瑙戒指中的#c地精灵瑪瑙#.
    ...
    public static int getHyperAddBullet(int id) {
        if (id == 4121013) { // 四飛閃
            return 4120051; // 四飛閃-攻击加成
        } else if (id == 5321012) { // 加農砲連擊
            return 5320051; // 加農砲連擊-獎勵攻击
        }
        return 0;
    }
    ...
    public static int getHyperAddAttack(int id) {
        if (id > 12120011) { // 極致熾烈
            if (id > 41121001) { // 神速無雙
                if (id > 61121100) { // 藍焰恐懼
                    if (id > 112101009) { // 電光石火
                        if (id == 112111004) { // 队伍轟炸
                            return 112120050; // 队伍轟炸-臨時目標
                    ...
                    switch (id) {
                        ...
                        case 51121008: // 聖光爆發
                            return 51120048; // 聖光爆發-攻击加成
                    }
                    return 0;
                }
                return 61120045; // 藍焰恐懼-加碼攻击
            }
            if (id == 41121001) { // 神速無雙
                ...
                if (id == 22181002) { // 龍神之怒
                    ...
                    return 31120044; // 惡魔氣息-攻击加成
                } else if (id == 31121001) { // 惡魔衝擊
                    return 31120050; // 惡魔衝擊-攻击加成
                } else if (id == 32111003) {
                    return 0;
                ...
                if (id - (13121000 + 2) - 2000000 == 5999002 + 1) { // 終極之矛
                    //LABEL_115:
                    return 21120047; // 終極之矛-加碼攻击
                } else if (id - (13121000 + 2) - 2000000 - (5999002 + 1) == 1) { // 極冰暴風
                    return 21120049; // 極冰暴風-加碼攻击
                }
            }
        } else {
            ...
            if (id <= 5121017) { // 爆烈衝擊波
                if (id >= 5121016) { // 蓄能衝擊波
                    return 5120051; // 蓄能衝擊波-攻击加成
                }
                if (id <= 3121015) { // 驟雨狂矢
                    switch (id) {
                        case 3121015: // 驟雨狂矢
                            return 3120048; // 驟雨狂矢-攻击加成
                        case 1120017: // 狂暴攻击
                        case 1121008: // 狂暴攻击
                            return 1120051; // 狂暴攻击-攻击加成
                        case 1221009: // 騎士衝擊波
                            return 1220048; // 騎士衝擊波-攻击加成
                        case 1221011: // 鬼神之擊
                            return 1220050; // 鬼神之擊-攻击加成
                        case 2121003: // 地獄爆發
                            return 2120049; // 地獄爆發-攻击加成
                        case 2121006: // 梅杜莎之眼
                            return 2120048; // 梅杜莎之眼-次數強化
                        case 2221006: // 閃電連擊
                            return 2220048; // 閃電連擊-攻击加成
                    }
                    return 0;
                }
                if (id == 3121020) { // 暴風神射
                ...
                if (id == 4221007) { // 瞬步連擊
                    return 4220048; // 瞬步連擊-攻击加成
                }
                if (id == 4331000) { // 血雨暴風狂斬
                    return 4340045; // 血雨暴風狂斬-攻击加成
                }
                if (id == 4341009) { // 幻影箭
            ...
            if (id > 5721064) { // 穿心掌打 
                ...
                if (id - 5121020 == 99996) { // 爆頭射擊
                    return 5220047; // 爆頭射擊-攻击加成
                } else {
                    if (id - 5121020 == 198991) {
                        //goto LABEL_116;
                    }
                    if (id - 5121020 == 199980) {// 加農砲火箭
                        return 5320048; // 加農砲火箭-攻击加成
                    }
                    if (id - 5121020 == 199984) { // 雙胞胎猴子
                        //LABEL_116:
                        return 5320043; // 雙胞胎猴子-伤害分裂
