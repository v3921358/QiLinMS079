...
//    格斗冒险岛("20-CF-30-94-27-44"),
    ;
    
    String mac;
    private AuthServerName(String mac) {
        this.mac = mac;
    }
    ...
    public static AuthServerName getName(String mac) {
        for (AuthServerName n : AuthServerName.values()) {
