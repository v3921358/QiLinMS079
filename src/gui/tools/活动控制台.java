...
public class 活动控制台 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane6.addTab("活动控制台", new javax.swing.ImageIcon(getClass().getResource("/Image/1.png")), jPanel20); // NOI18N
    ...
    private void 刷新周末倍率开关() {
        String 显示 = "";
        int S = gui.Qhms.ConfigValuesMap.get("周末倍率开关");
        if (S <= 0) {
            显示 = "开启";
        } else {
            显示 = "关闭";
    ...
    private void 刷新神秘商人开关() {
        String 显示 = "";
        int S = gui.Qhms.ConfigValuesMap.get("神秘商人开关");
        if (S <= 0) {
            显示 = "开启";
        } else {
            显示 = "关闭";
     ...
     private void 刷新幸运职业开关() {
        String 显示 = "";
        int S = gui.Qhms.ConfigValuesMap.get("幸运职业开关");
        if (S <= 0) {
            显示 = "开启";
        } else {
            显示 = "关闭";
    ...
    private void 刷新野外通缉开关() {
        String 显示 = "";
        int S = gui.Qhms.ConfigValuesMap.get("野外通缉开关");
        if (S <= 0) {
            显示 = "开启";
        } else {
            显示 = "关闭";
     ...
     private void 刷新魔族突袭开关() {
        String 显示 = "";
        int S = gui.Qhms.ConfigValuesMap.get("魔族突袭开关");
        if (S <= 0) {
            显示 = "开启";
        } else {
            显示 = "关闭";
     ...
     private void 刷新魔族攻城开关() {
        String 显示 = "";
        int S = gui.Qhms.ConfigValuesMap.get("魔族攻城开关");
        if (S <= 0) {
            显示 = "开启";
        } else {
            显示 = "关闭";
