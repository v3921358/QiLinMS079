...
public class PracticerCommand {
    ...
    public static class online extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String[] splitted) {
            ...
            c.getPlayer().dropMessage(6, new StringBuilder().append("当前伺服器总计线上人数: ").append(totalOnline).append("个").toString());
            c.getPlayer().dropMessage(6, "-------------------------------------------------------------------------------------");
    ...
    public static class onlineGM extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String[] splitted) {
            ...
            c.getPlayer().dropMessage(6, new StringBuilder().append("当前伺服器GM总计线上人数: ").append(totalOnline).append("个").toString());
            c.getPlayer().dropMessage(6, "-------------------------------------------------------------------------------------");
            return true;
        }
