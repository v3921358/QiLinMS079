...
public class AdminCommand {
    ...
    public static class GainCash extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String splitted[]) {
            ...
            String msg = "[GM 密语] GM " + c.getPlayer().getName() + " 给了 " + player.getName() + " 点卷 " + amount + "点";
    ...
    public static class GainMaplePoint extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String splitted[]) {
            ...
            String msg = "[GM 密语] GM " + c.getPlayer().getName() + " 给了 " + player.getName() + " 抵用卷 " + amount + "点";
            World.Broadcast.broadcastGMMessage(MaplePacketCreator.serverNotice(6, msg));
            return true;
        }
    ...
    public static class 给金币 extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String splitted[]) {
            ...
            if (victim == null) {
                ...
                victim.gainMeso(gain, false);
                String msg = "[GM 密语] GM " + c.getPlayer().getName() + " 给了 " + victim.getName() + " 枫币 " + gain + "点";
                World.Broadcast.broadcastGMMessage(MaplePacketCreator.serverNotice(6, msg));
            }
            return true;
        }
    ...
    public static class 给全体玩家金币 extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String splitted[]) {
            ...
            String msg = "[GM 密语] GM " + c.getPlayer().getName() + " 给了 所有玩家 枫币 " + gain + "点";
            World.Broadcast.broadcastGMMessage(MaplePacketCreator.serverNotice(6, msg));
            return true;
        }
    ...
    public static class 传送所有玩家 extends CommandExecute {
        ...
        @Override
        public String getMessage() {
            return new StringBuilder().append("!传送所有玩家 把所有玩家传送到GM这裡").toString();
        }
    }
    ...
    public static class MesoMap extends CommandExecute {
        ...
        public boolean execute(MapleClient c, String splitted[]) {
            if (splitted.length > 1) {
                ...
                final MapleMap froma = c.getPlayer().getMap();
                for (MapleCharacter chrrr : froma.getCharactersThreadsafe()) {
                    chrrr.startMapEffect("管理员发放" + quantity + "枫币给地图的所有玩家！祝您玩得开心快乐", 5121009);
                }
    ...
    public static class 刷 extends CommandExecute {//Item
        ...
        public boolean execute(MapleClient c, String splitted[]) {
            ...
            if (GameConstants.isPet(itemId)) {
                ...
                item.setGMLog(c.getPlayer().getName());
                MapleInventoryManipulator.addbyItem(c, item);
                if (gui.Qhms.ConfigValuesMap.get("指令通知开关") <= 0) {
