...
public class PlayerStats implements Serializable {
    ...
    public transient boolean equippedWelcomeBackRing, equippedFairy, hasMeso, hasItem, hasVac, hasClone, hasPartyBonus, Berserk = false, isRecalc = false, equippedRing;
...
//            lock.unlock();
        ...
        if (buff != null) {
            ...
            } else if (chra.getBuffSource(MapleBuffStat.DROP_RATE) == 2382001) { // 封包傳回2倍，介紹寫50%
                realMesoBuff += 100;
                mesoBuff *= 200.0 / 100.0;
                realDropBuff += 200;
                dropBuff *= 300.0 / 100.0;
